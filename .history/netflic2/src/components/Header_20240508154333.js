...
export const Header = () => {
  const user = useSelector(store => store.app.user); // Get user from Redux store
...
const toggleHandler = () => {
  ...
  return (
    <div className='absolute z-10 flex w-full items-center px-6 justify-between bg-gradient-to-b from-black'>
      <img className='w-56 h-10' src={LOGO} alt="netflix-logo" />
